    ...
    describe "Admin" do
      describe "team_members", type: :feature do
        ...
        describe "team_members list" do
          before do
            FactoryGirl.create(:team_member, :first_name => "UniqueTitleOne")
            FactoryGirl.create(:team_member, :first_name => "UniqueTitleTwo")
          end
        ...
        describe "create" do
          ...
          context "duplicate" do
            before { FactoryGirl.create(:team_member, :first_name => "UniqueTitle") }
        ...
        describe "edit" do
          before { FactoryGirl.create(:team_member, :first_name => "A first_name") }
        ...
        describe "destroy" do
          before { FactoryGirl.create(:team_member, :first_name => "UniqueTitleOne") }
